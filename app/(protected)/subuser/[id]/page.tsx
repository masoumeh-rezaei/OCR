...
import EditSubUserForm from '@/component/Forms/editSubUserForm';
...
export default function EditSubUserPage() {
    ...
    return (
        <div className="relative flex flex-col md:flex-row w-full min-h-screen bg-[#F8F9FB] dark:bg-darkBg overflow-hidden">
            ...
            <button
                onClick={() => router.back()}
                className="absolute left-4 top-4 z-50 text-gray-500 hover:text-blue-600 transition flex items-center gap-1"
                aria-label="Back"
            >
