...
import { useChoosePlan } from '@/hooks/usePlans';
                    ...
                    <>
                        ...
                        <div className="mt-6">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-darkBg text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-blue"
                            />
                        </div>
                        ...
                        <div className="mt-8 flex justify-center">
                            <button
                                onClick={() => {
                                    mutate(
                                        { plan_id: plan.id, billing_cycle: billingPeriod, discount_code: discountCode || undefined},
                                        {
                                            onSuccess: () => {
                                            ...
                                            onError: (err: unknown) => {
                                                ...
                                                toast.error(t('error_choosing_plan') || errorMessage);
                                            },
                                ...
                                className="inline-flex items-center justify-center gap-2 bg-blue/90 text-white dark:text-white hover:bg-blue  font-medium py-2.5 px-6 rounded-lg transition"
                            >
